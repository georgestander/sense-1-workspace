...
export const IPC_CHANNELS = {
  ...
  acknowledgeDesktopCrashReport: "sense1:desktop:reports:acknowledge-crash",
  ...
  browserGoBack: "sense1:desktop:browser:go-back",
  browserGoForward: "sense1:desktop:browser:go-forward",
  browserReload: "sense1:desktop:browser:reload",
  browserStop: "sense1:desktop:browser:stop",
  browserSetViewport: "sense1:desktop:browser:set-viewport",
  browserScreenshot: "sense1:desktop:browser:screenshot",
  browserInspect: "sense1:desktop:browser:inspect",
  browserClick: "sense1:desktop:browser:click",
  browserType: "sense1:desktop:browser:type",
  browserConsole: "sense1:desktop:browser:console",
  browserNetwork: "sense1:desktop:browser:network",
  browserTrustCheck: "sense1:desktop:browser:trust-check",
  browserTrustUpdate: "sense1:desktop:browser:trust-update",
  browserTrustState: "sense1:desktop:browser:trust-state",
} as const;
